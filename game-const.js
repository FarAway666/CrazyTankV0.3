...
const WEAPONS = {
    mg:      { name: '机枪',   dmg: 0.75, cd: 35,   speed: 120, color: 0xff4400, size: 0.15 },
    cannon:  { name: '狙击枪', dmg: 35,  cd: 2000,  speed: 550,  color: 0xffaa00, size: 0.1  },
    shotgun: { name: '霰弹枪', dmg: 2.5,   cd: 1000, speed: 200,  color: 0x00ff88, size: 0.05, pelletCount: 15 },
    emgun:   { name: '冰冻枪', dmg: 4.5,   cd: 500,  speed: 200, color: 0x0088ff, size: 0.12, stunDuration: 300 },
    toxic:   { name: '剧毒炮', dmg: 2,   cd: 400,  speed: 120, color: 0x6600aa, size: 0.14, dotDurationPerHit: 2000, dotMaxDuration: 10000, dotDps: 4, poisonVisualColor: 0x8800ff }
};
